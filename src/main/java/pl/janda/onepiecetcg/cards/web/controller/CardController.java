...
import pl.janda.onepiecetcg.cards.web.dto.CardDto;
import pl.janda.onepiecetcg.cards.web.dto.CardErrataDto;
import pl.janda.onepiecetcg.cards.web.dto.CardFilterOptionsDto;
import pl.janda.onepiecetcg.cards.web.dto.CardSearchRequest;
import pl.janda.onepiecetcg.cards.web.dto.CardSearchResponse;
import pl.janda.onepiecetcg.cards.web.mapper.CardErrataMapper;
import pl.janda.onepiecetcg.cards.web.mapper.CardMapper;
...
public class CardController {
    ...
    public ResponseEntity<List<String>> getAllCardCodes() {
        return ResponseEntity.ok(cardService.getAllCardCodes());
    }
